...
try:
    ...
    TELEGRAM_CHAT_IDS = os.environ["TELEGRAM_CHAT_IDS"]  # comma-separated IDs: personal, group
...
def send_telegram_alert(message):
    chat_ids = [cid.strip() for cid in TELEGRAM_CHAT_IDS.split(',')]
    for chat_id in chat_ids:
        try:
            ...
            if response.status_code == 200 and resp_json.get("ok"):
                ...
                print(f"[TELEGRAM] Failed for {chat_id}! Response: {resp_json}")
